export const enUS: Record<string, string> = {
  ...
  "nz-row.nzGutter.description": "Spacing between grids, could be a [string CSS units](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Values_and_Units) or a object like `{ xs: 8, sm: 16, md: 24}`. Or you can use array to make horizontal and vertical spacing work at the same time `[horizontal, vertical]`",
  "nz-row.nzJustify.description": "Horizontal arrangement",
  "nz-row.nzWrap.description": "Auto wrap line",
  "nz-col.title": "Grid",
  "nz-col.whenToUse": "",
  "nz-col.description": "",
  ...
  "nz-col.nzXs.description": "`screen < 576px` and also default setting, could be a `span` value or an object containing above props",
  "nz-col.nzSm.description": "`screen ≥ 576px`, could be a `span` value or an object containing above props",
  "nz-col.nzMd.description": "`screen ≥ 768px`, could be a `span` value or an object containing above props",
  "nz-col.nzLg.description": "`screen ≥ 992px`, could be a `span` value or an object containing above props",
  "nz-col.nzXl.description": "`screen ≥ 1200px`, could be a `span` value or an object containing above props",
  "nz-col.nzXXl.description": "`screen ≥ 1600px`, could be a `span` value or an object containing above props",
  "nz-col.nzXXXl.description": "`screen ≥ 1920px`, could be a `span` value or an object containing above props",
  ...
  "nz-alert-marquee.title": "Alert",
  "nz-alert-marquee.whenToUse": "- When you need to show alert messages to users.\n- When you need a persistent static container which is closable by user actions.",
  "nz-alert-marquee.description": "Use `nz-alert-marquee` as the `[nzMessage]` template content to create a scrolling loop banner inside an alert.",
  "nz-alert-marquee.nzPauseOnHover.description": "Whether to pause the scrolling animation on mouse hover",
  "nz-alert-marquee.nzSpeed.description": "Animation speed in pixels per second (higher = faster scrolling)",
  ...
  "nz-autocomplete.nzDropdownMatchSelectWidth.description": "Whether dropdown's width is same width than select.",
  ...
  "nz-badge.whenToUse": "Badge normally appears in proximity to notifications or user avatars with eye-catching appeal, typically displaying\nunread messages count.",
  ...
  "nz-ribbon.whenToUse": "Badge normally appears in proximity to notifications or user avatars with eye-catching appeal, typically displaying\nunread messages count.",
  ...
  "nz-color-picker.nzPresets.description": "Preset colors",
  ...
  "nz-cron-expression.nzStatus.description": "Set validation status",
  ...
  "nz-form.nzVariant.description": "Set form variant",
  ...
  "nz-form-item.nzGutter.description": "Spacing between grids, could be a [string CSS units](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Values_and_Units) or a object like `{ xs: 8, sm: 16, md: 24}`. Or you can use array to make horizontal and vertical spacing work at the same time `[horizontal, vertical]`",
  "nz-form-item.nzJustify.description": "Horizontal arrangement",
  "nz-form-item.nzWrap.description": "Auto wrap line",
  "nz-form-item.nzLayout.description": "Form item layout",
  ...
  "nz-form-label.nzXs.description": "`screen < 576px` and also default setting, could be a `span` value or an object containing above props",
  "nz-form-label.nzSm.description": "`screen ≥ 576px`, could be a `span` value or an object containing above props",
  "nz-form-label.nzMd.description": "`screen ≥ 768px`, could be a `span` value or an object containing above props",
  "nz-form-label.nzLg.description": "`screen ≥ 992px`, could be a `span` value or an object containing above props",
  "nz-form-label.nzXl.description": "`screen ≥ 1200px`, could be a `span` value or an object containing above props",
  "nz-form-label.nzXXl.description": "`screen ≥ 1600px`, could be a `span` value or an object containing above props",
  "nz-form-label.nzXXXl.description": "`screen ≥ 1920px`, could be a `span` value or an object containing above props",
  ...
  "nz-form-control.nzXs.description": "`screen < 576px` and also default setting, could be a `span` value or an object containing above props",
  "nz-form-control.nzSm.description": "`screen ≥ 576px`, could be a `span` value or an object containing above props",
  "nz-form-control.nzMd.description": "`screen ≥ 768px`, could be a `span` value or an object containing above props",
  "nz-form-control.nzLg.description": "`screen ≥ 992px`, could be a `span` value or an object containing above props",
  "nz-form-control.nzXl.description": "`screen ≥ 1200px`, could be a `span` value or an object containing above props",
  "nz-form-control.nzXXl.description": "`screen ≥ 1600px`, could be a `span` value or an object containing above props",
  "nz-form-control.nzXXXl.description": "`screen ≥ 1920px`, could be a `span` value or an object containing above props",
  ...
  "nz-input-wrapper.title": "Input",
  "nz-input-wrapper.whenToUse": "- A user input in a form field is needed.\n- A search input is required.",
  "nz-input-wrapper.description": "Use when you need to add extra functionality to `[nz-input]`.",
  "nz-input-wrapper.nzAddonBefore.description": "The label text displayed before (on the left side of) the input field",
  "nz-input-wrapper.nzAddonAfter.description": "The label text displayed after (on the right side of) the input field",
  "nz-input-wrapper.nzPrefix.description": "The prefix icon for the Input",
  "nz-input-wrapper.nzSuffix.description": "The suffix icon for the Input",
  "nz-input-wrapper.nzAllowClear.description": "If allow to remove input content with clear icon",
  "nz-input-wrapper.nzShowCount.description": "Should the character count be displayed",
  "nz-input-wrapper.nzCount.description": "Custom character counting config",
  "nz-input-wrapper.nzClear.description": "Event emitted when the clear icon is clicked",
  "nz-input-password.title": "Input",
  "nz-input-password.whenToUse": "- A user input in a form field is needed.\n- A search input is required.",
  "nz-input-password.description": "All properties of `nz-input-wrapper` can be used.",
  "nz-input-password.nzVisibilityToggle.description": "Whether to show the toggle button",
  "nz-input-password.nzVisible.description": "Whether the password is visible, supports two-way binding",
  "nz-input-password.nzVisibleChange.description": "Event emitted when the visibility of the password changes",
  "nz-input-search.title": "Input",
  "nz-input-search.whenToUse": "- A user input in a form field is needed.\n- A search input is required.",
  "nz-input-search.description": "All properties of `nz-input-wrapper` can be used.",
  "nz-input-search.nzEnterButton.description": "false displays the default button color, true uses the primary color, or you can provide a custom button. Conflicts with `nzAddonAfter`.",
  "nz-input-search.nzLoading.description": "Search box with loading",
  "nz-input-search.nzSearch.description": "The event triggered when you click on the search-icon, the clear-icon or press the Enter key",
  "nz-input-group.title": "Input",
  "nz-input-group.whenToUse": "- A user input in a form field is needed.\n- A search input is required.",
  "nz-input-group.description": "⚠️ `nz-input-group` has been deprecated in `v20.0.0` and will be removed in `v22.0.0`. Please use the `nz-input-wrapper` component instead.",
  ...
  "nz-input-number.title": "InputNumber",
  "nz-input-number.whenToUse": "When a numeric value needs to be provided.",
  "nz-input-number.description": "",
  "nz-input-number.ngModel.description": "current value, two way binding",
  "nz-input-number.nzId.description": "ID of the input box",
  "nz-input-number.nzPlaceHolder.description": "placeholder",
  "nz-input-number.nzAutoFocus.description": "auto focus",
  ...
  "nz-input-number.nzDisabled.description": "whether to disable",
  "nz-input-number.nzFormatter.description": "specify the format of the displayed value",
  "nz-input-number.nzKeyboard.description": "Whether to enable keyboard shortcuts",
  "nz-input-number.nzChangeOnWheel.description": "Whether to enable mouse wheel control",
  "nz-input-number.nzMax.description": "maximum value",
  "nz-input-number.nzMin.description": "minimum value",
  "nz-input-number.nzParser.description": "specify how to convert back to a number from `formatter`, used with `formatter`",
  "nz-input-number.nzPrecision.description": "numerical precision, the `formatter` configuration takes precedence",
  "nz-input-number.nzReadOnly.description": "whether to read only",
  "nz-input-number.nzStatus.description": "status, optional `error` `warning`",
  "nz-input-number.nzSize.description": "input box size, optional `large` `default` `small`",
  "nz-input-number.nzStep.description": "step of each change, can be a decimal",
  "nz-input-number.nzAddonBefore.description": "The label text displayed before (on the left side of) the input-number",
  "nz-input-number.nzAddonAfter.description": "The label text displayed after (on the right side of) the input-number",
  "nz-input-number.nzPrefix.description": "The prefix icon for the input-number",
  "nz-input-number.nzSuffix.description": "The suffix icon for the input-number",
  "nz-input-number.nzOnStep.description": "callback when clicking the up and down arrows",
  "nz-input-number.nzFocus.description": "callback when focus",
  "nz-input-number.nzBlur.description": "callback when blur",
  "nz-input-number.ngModelChange.description": "callback function when the value changes",
  ...
  "nz-modal.nzStyle.description": "Style of overlay layer, typically used at least for adjusting the position.",
  ...
  "nz-pagination.nzAlign.description": "Align",
  ...
  "nz-popconfirm.nzIcon.description": "Customize icon of confirmation. Set to `null` to hide the icon",
  ...
  "nz-qrcode.nzType.description": "render type",
  ...
  "nz-qrcode.nzBoostLevel.description": "If enabled, the Error Correction Level of the result may be higher than the specified Error Correction Level",
  ...
  "th.nzShowSort.description": "Whether to display sorting",
  "th.nzSortFn.description": "Sort function used to sort the data on client side (ref to `Array.sort` compareFunction). Should be set to `true` when using server side sorting",
  "th.nzSortOrder.description": "Sort direction",
  "th.nzSortDirections.description": "Supported sort order, could be `'descend'`, `'ascend'`, `null`",
  "th.nzSortOrderChange.description": "Callback when sort direction changes",
  ...
  "nz-tabs.nzIndicator.description": "Custom indicator size and align",
  ...
  "nz-tree.nzDraggable.description": "Specifies whether this Tree is draggable",
  ...
  "nz-tree-select.nzOpen.description": "dropdown expand state, double binding",
  ...
  "nz-tree-select.nzOpenChange.description": "dropdown expand change callback",
  ...
  "nz-tree-view.nzLevelAccessor.description": "The level accessor of tree node ([levelAccessor](https://material.angular.io/cdk/tree/api#CdkTree)), used with flat data.",
  "nz-tree-view.nzChildrenAccessor.description": "The children accessor of tree node ([childrenAccessor](https://material.angular.io/cdk/tree/api#CdkTree)), used with nested data.",
  "nz-tree-view.nzTrackBy.description": "Tracking function that will be used to check the differences in data changes. Used similarly to ngFor trackBy function.",
  ...
  "nz-tree-virtual-scroll-view.nzLevelAccessor.description": "The level accessor of tree node ([levelAccessor](https://material.angular.io/cdk/tree/api#CdkTree)), used with flat data.",
  "nz-tree-virtual-scroll-view.nzChildrenAccessor.description": "The children accessor of tree node ([childrenAccessor](https://material.angular.io/cdk/tree/api#CdkTree)), used with nested data.",
  "nz-tree-virtual-scroll-view.nzTrackBy.description": "Tracking function that will be used to check the differences in data changes. Used similarly to ngFor trackBy function.",
  ...
  "nz-tree-node.nzExpandable.description": "[Whether or not this tree node is expandable](https://material.angular.io/cdk/tree/api#CdkTreeNode). Please set this parameter value when using `nzLevelAccessor` or `nzChildrenAccessor`.",
  ...
  "nz-upload.nzId.description": "input id attribute inside the component",
  ...
  "nz-upload.nzMaxCount.description": "Limit the file displayed in uploaded files list. Will replace current one when maxCount is 1 unlimited",
  ...
  "nz-upload.nzShowUploadList.description": "Whether to show the default upload list, could be an object to specify `extra`, `showPreviewIcon`, `showRemoveIcon`, `showDownloadIcon`, `previewIcon`, `removeIcon` and `downloadIcon` individually",
  ...
  "nz-watermark.title": "Watermark",
  "nz-watermark.whenToUse": "- Use when the page needs to be watermarked to identify the copyright.\n- Suitable for preventing information theft.",
  "nz-watermark.description": "",
  "nz-watermark.nzContent.description": "Watermark text content",
  "nz-watermark.nzWidth.description": "The width of the watermark, the default value of `nzContent` is its own width",
  "nz-watermark.nzHeight.description": "The height of the watermark, the default value of `nzContent` is its own height",
  "nz-watermark.nzRotate.description": "When the watermark is drawn, the rotation Angle, unit `°`",
  "nz-watermark.nzZIndex.description": "The z-index of the appended watermark element",
  "nz-watermark.nzImage.description": "Image source, it is recommended to export 2x or 3x image, high priority (support base64 format)",
  "nz-watermark.nzFont.description": "Text style",
  "nz-watermark.nzGap.description": "The spacing between watermarks",
  "nz-watermark.nzOffset.description": "The offset of the watermark from the upper left corner of the container. The default is `nzGap/2`",
  "nz-watermark.color.description": "font color",
  "nz-watermark.fontSize.description": "font size",
  "nz-watermark.fontWeight.description": "font weight",
  "nz-watermark.fontFamily.description": "font family",
  "nz-watermark.fontStyle.description": "font style",
  ...
  "reuse-tab.routeParamMatchMode.description": "Match the pattern when routing parameters are included, for example:`/view/:id`<br> - `strict` Strict mode `/view/1`, `/view/2` Different pages<br> - `loose` Loose mode `/view/1`, `/view/2` Same page and only one tab of component<br> - `((future: ActivatedRouteSnapshot, curr: ActivatedRouteSnapshot) => boolean)` custom function",
  ...
  "reuse-tab.trackByFn.description": "`track` function for `nz-tabs`",
  ...
  "st.checkboxIdMap.description": "The identifier column of the cached checkbox list",
  ...
  "sf.expandable.description": "Whether to enable expand/collapse",
  "sf.expanded.description": "Expand/Collapse state, support two-way binding",
