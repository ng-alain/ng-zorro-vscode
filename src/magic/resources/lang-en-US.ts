export const enUS: Record<string, string> = {
  ...
  "nz-anchor.nzTargetOffset.description": "Anchor scroll offset, default as `offsetTop`, [example](#components-anchor-demo-targetOffset)",
  ...
  "nz-avatar.nzSrc.description": "The address of the image for an image avatar",
  ...
  "nz-button-group.title": "Button",
  "nz-button-group.whenToUse": "A button means an operation (or a series of operations). Clicking a button will trigger corresponding business logic.",
  "nz-button-group.description": "",
  "nz-button-group.nzSize.description": "can be set to `small` `large` or omitted",
  ...
  "nz-cron-expression.whenToUse": "When you want to use cron in Angular.",
  ...
  "nz-float-button-group.nzShape.description": "Set button group shape",
  ...
  "nz-float-button-top.nzDuration.description": "Time to return to top (ms)",
  "nz-float-button-top.nzOnClick.description": "a callback function, which can be executed when you click the button",
  "nz-form.title": "Form",
  "nz-form.whenToUse": "",
  "nz-form.description": "",
  ...
  "nz-hashCode.title": "HashCode",
  "nz-hashCode.whenToUse": "",
  "nz-hashCode.description": "",
  "nz-hashCode.nzValue.description": "The value of the hash code",
  "nz-hashCode.nzTitle.description": "Description of the content in the upper left corner",
  "nz-hashCode.nzLogo.description": "Display in the upper right corner",
  "nz-hashCode.nzMode.description": "Demonstration Mode",
  "nz-hashCode.nzType.description": "style",
  "nz-hashCode.nzOnCopy.description": "Clicking the Copy callback",
  "nz-icon.title": "Icon",
  "nz-icon.whenToUse": "",
  "nz-icon.description": "",
  ...
  "nz-input-group.nzCompact.description": "Whether use compact style",
  ...
  "nz-input-number-group.nzCompact.description": "Whether use compact style",
  ...
  "nz-modal.nzFooter.description": "Footer content, set as footer=null when you don't need default buttons. <i>1. Only valid in normal mode.<br>2. You can customize the buttons to the maximum extent by passing a `ModalButtonOptions` configuration (see the case or the instructions below).</i>",
  ...
  "nz-pagination.nzSize.description": "specify the size of `nz-pagination`, can be set to `small`",
  ...
  "nzBytes.title": "Pipes",
  "nzBytes.whenToUse": "- After introducing Pipe, use it like Angular's built-in Pipe",
  "nzBytes.description": "",
  ...
  "nzToCssUnit.whenToUse": "- After introducing Pipe, use it like Angular's built-in Pipe",
  "nzToCssUnit.description": "",
  "nzToCssUnit.defaultUnit.description": "Default Unit",
  "nzEllipsis.title": "Pipes",
  "nzEllipsis.whenToUse": "- After introducing Pipe, use it like Angular's built-in Pipe",
  ...
  "nzAggregate.whenToUse": "- After introducing Pipe, use it like Angular's built-in Pipe",
  "nzAggregate.description": "",
  "nzAggregate.method.description": "Aggregation",
  "nzSanitizer.title": "Pipes",
  "nzSanitizer.whenToUse": "- After introducing Pipe, use it like Angular's built-in Pipe",
  "nzSanitizer.description": "",
  "nzSanitizer.type.description": "sanitizer type",
  "nz-popconfirm.title": "Popconfirm",
  "nz-popconfirm.whenToUse": "A simple and compact dialog used for asking for user confirmation.",
  ...
  "nz-popconfirm.nzCancelText.description": "Text of the Cancel button",
  "nz-popconfirm.nzOkText.description": "Text of the Confirm button",
  "nz-popconfirm.nzOkType.description": "Button `type` of the Confirm button",
  "nz-popconfirm.nzOkDanger.description": "Danger status of the OK button. <i>Consistent with the `nzDanger` of the `nz-button`.</i>",
  "nz-popconfirm.nzOkDisabled.description": "prevents a user from interacting with the OK button. <i>Consistent with the `disabled` of the `nz-button`.</i>",
  ...
  "nz-qrcode.whenToUse": "Used when the link needs to be converted into a QR Code.",
  "nz-qrcode.description": "",
  "nz-qrcode.nzValue.description": "scanned link",
  ...
  "nz-option.nzCustomContent.description": "Whether custom nz-option content in drodown menu, the ng-content in nz-option will replace nzLabel when it was set to true",
  ...
  "nz-steps.whenToUse": "When the task is complicated or has a certain sequence in the series of subtasks, we can decompose it into several steps to make things easier.",
  ...
  "nz-step.title": "Steps",
  "nz-step.whenToUse": "When the task is complicated or has a certain sequence in the series of subtasks, we can decompose it into several steps to make things easier.",
  ...
  "th.nzSortDirections.description": "Supported sort order, could be `'ascend'`, `'descend'`, `null`",
  ...
  "nz-tabset.title": "Tabs",
  "nz-tabset.whenToUse": "Ant Design has 3 types of Tabs for different situations.",
  "nz-tabset.description": "",
  "nz-tabset.nzSelectedIndex.description": "Current tab's index",
  "nz-tabset.nzAnimated.description": "Whether to change tabs with animation. Only works while `nzTabPosition=\"top\" | \"bottom\"`",
  "nz-tabset.nzSize.description": "preset tab bar size",
  "nz-tabset.nzTabBarExtraContent.description": "Extra content in tab bar",
  "nz-tabset.nzTabBarStyle.description": "Tab bar style object",
  "nz-tabset.nzTabPosition.description": "Position of tabs",
  "nz-tabset.nzType.description": "Basic style of tabs",
  "nz-tabset.nzTabBarGutter.description": "The gap between tabs",
  "nz-tabset.nzHideAll.description": "Whether hide all tabs",
  "nz-tabset.nzLinkRouter.description": "Link with Angular router. It supports child mode and query param mode",
  "nz-tabset.nzLinkExact.description": "Use exact routing matching",
  "nz-tabset.nzCanDeactivate.description": "Determine if a tab can be deactivated",
  "nz-tabset.nzCentered.description": "Centers tabs",
  "nz-tabset.nzDestroyInactiveTabPane.description": "Whether destroy inactive TabPane when change tab",
  "nz-tabset.nzSelectedIndexChange.description": "Current tab's index change callback",
  "nz-tabset.nzSelectChange.description": "Current tab's change callback",
  "nz-tab.title": "Tabs",
  ...
  "nz-transfer.whenToUse": "Transfer the elements between two columns intuitively and efficiently.",
  ...
  "nz-tree-virtual-scroll-view.title": "Tree View",
  ...
  "nzTreeNodePadding.title": "Tree View",
  ...
  "nzTreeNodeIndentLine.title": "Tree View",
  ...
  "nz-tree-node-toggle.title": "Tree View",
  ...
  "nzTreeNodeToggleRotateIcon.title": "Tree View",
  ...
  "nzTreeNodeToggleActiveIcon.title": "Tree View",
  ...
  "nz-tree-node-option.title": "Tree View",
  ...
  "nz-tree-node-checkbox.title": "Tree View",
  ...
  "nz-upload.nzFilter.description": "Custom filter when choosed file",
  ...
  "avatar-list.title": "AvatarList",
  "avatar-list.whenToUse": "",
  "avatar-list.description": "",
  "avatar-list.size.description": "size of list",
  "avatar-list.maxLength.description": "max items to show",
  "avatar-list.excessItemsStyle.description": "the excess item style",
  "avatar-list-item.title": "AvatarList",
  "avatar-list-item.whenToUse": "",
  "avatar-list-item.description": "",
  "avatar-list-item.tips.description": "title tips for avatar item",
  "avatar-list-item.src.description": "the address of the image for an image avatar",
  "avatar-list-item.text.description": "text for avatar item",
  "avatar-list-item.icon.description": "icon for avatar item",
  ...
  "result.whenToUse": "",
  "result.description": "",
  "result.type.description": "Types, different types come with corresponding icons",
  "result.title.description": "Title for the result",
  "result.description.description": "Description for the result",
  "result.extra.description": "Supplemental information, with default gray background",
  "result.ng-content.description": "Operation suggestions, Recommended to place jump links, button groups, etc.",
