...
'nz-button.description': localize('nz-button.description', 'Note：nz-button is Directive, it accepts all props which native button [support](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/button).'),
'nz-button.disabled.description': localize('nz-button.disabled.description', 'prevents user from interacting with the button'),
...
'nz-drawer.nzClosable.description': localize('nz-drawer.nzClosable.description', 'Whether a close (x) button is visible on top right of the Drawer dialog or not.'),
...
'nz-drawer.nzWidth.description': localize('nz-drawer.nzWidth.description', 'Width of the Drawer dialog, only when placement is `\'right\'` or `\'left\'`.'),
'nz-drawer.nzHeight.description': localize('nz-drawer.nzHeight.description', 'Height of the Drawer dialog, only when placement is `\'top\'` or `\'bottom\'`.'),
...
'nz-graph.title': localize('nz-graph.title', 'Hierarchy Graph'),
...
'nz-graph.nzAutoFit.description': localize('nz-graph.nzAutoFit.description', 'Whether to automatically adjust the height of the node, the default equal height'),
'nz-graph-zoom.title': localize('nz-graph-zoom.title', 'Hierarchy Graph'),
...
'nzGraphNode.title': localize('nzGraphNode.title', 'Hierarchy Graph'),
...
'nzGraphEdge.title': localize('nzGraphEdge.title', 'Hierarchy Graph'),
...
'nz-modal.nzGetContainer.description': localize('nz-modal.nzGetContainer.description', 'The mount node for Modal'),
...
'nz-table.nzTotal.description': localize('nz-table.nzTotal.description', 'Total data count. Should set when `nzServerRender` is `true`'),
...
'th.nzWidth.description': localize('th.nzWidth.description', 'Specify the column width, can not used when grouping columns'),
...
'nz-transfer.nzDataSource.description': localize('nz-transfer.nzDataSource.description', 'Used for setting the source data. Except the elements whose keys are `direction: \'right\'` prop , or using `nzTargetKeys` prop.'),
'nz-transfer.nzDisabled.description': localize('nz-transfer.nzDisabled.description', 'Whether disabled transfer'),
...
'nz-transfer.nzListStyle.description': localize('nz-transfer.nzListStyle.description', 'A custom CSS style used for rendering the transfer columns. equal `ngStyle`'),
...
'nz-transfer.nzShowSearch.description': localize('nz-transfer.nzShowSearch.description', 'If included, a search box is shown on each column.'),
'nz-transfer.nzFilterOption.description': localize('nz-transfer.nzFilterOption.description', 'A function to determine whether an item should show in search result list'),
...
'nz-transfer.nzCanMove.description': localize('nz-transfer.nzCanMove.description', 'Two verification when transfer choice box. please refer to the case.'),
...
'nz-tree-virtual-scroll-view.nzNodeWidth.description': localize('nz-tree-virtual-scroll-view.nzNodeWidth.description', 'The width of nodes in the tree (in pixels)'),
...
'nz-upload.whenToUse': localize('nz-upload.whenToUse', 'Uploading is the process of publishing information (web pages, text, pictures, video, etc.) to a remote server via a web page or upload tool.'),
...
'nz-upload.nzDirectory.description': localize('nz-upload.nzDirectory.description', 'support upload whole directory ([caniuse](https://caniuse.com/#feat=input-file-directory))'),
'nz-upload.nzBeforeUpload.description': localize('nz-upload.nzBeforeUpload.description', 'Hook function which will be executed before uploading. Uploading will be stopped with `false` or a Observable. **Warning：this function is not supported in IE9**. NOTICE: Must use `=>` to define the method.'),
'nz-upload.nzCustomRequest.description': localize('nz-upload.nzCustomRequest.description', 'override for the default xhr behavior allowing for additional customization and ability to implement your own XMLHttpRequest. NOTICE: Must use `=>` to define the method.'),
...
'nz-upload.nzMultiple.description': localize('nz-upload.nzMultiple.description', 'Whether to support selected multiple file. `IE10+` supported. You can select multiple files with CTRL holding down while multiple is set to be true'),
'nz-upload.nzName.description': localize('nz-upload.nzName.description', 'The name of uploading file'),
'nz-upload.nzShowUploadList.description': localize('nz-upload.nzShowUploadList.description', 'Whether to show default upload list, could be an object to specify `showPreviewIcon`, `showRemoveIcon` and `showDownloadIcon` individually'),
...
'nz-upload.nzPreview.description': localize('nz-upload.nzPreview.description', 'A callback function, will be executed when file link or preview icon is clicked. NOTICE: Must use `=>` to define the method.'),
...
'nz-upload.nzRemove.description': localize('nz-upload.nzRemove.description', 'A callback function, will be executed when removing file button is clicked, remove event will be prevented when return value is `false` or a Observable. NOTICE: Must use `=>` to define the method.'),
...
'range-picker.description': localize('range-picker.description', 'Based on the `nz-range-picker` further optimization, better service to start and end dates.'),
'range-picker.ngModel.description': localize('range-picker.ngModel.description', 'Start date, start and end values at the same time'),
'range-picker.ngModelEnd.description': localize('range-picker.ngModelEnd.description', 'End date, start and end values at the same time'),
'range-picker.shortcut.description': localize('range-picker.shortcut.description', 'Set shortcuts'),
'range-picker.nzAllowClear.description': localize('range-picker.nzAllowClear.description', 'Whether to show clear button'),
'range-picker.nzAutoFocus.description': localize('range-picker.nzAutoFocus.description', 'get focus when component mounted'),
'range-picker.nzClassName.description': localize('range-picker.nzClassName.description', 'picker className'),
'range-picker.nzDateRender.description': localize('range-picker.nzDateRender.description', 'custom rendering function for date cells (Not support by month-picker/year-picker)'),
'range-picker.nzDisabled.description': localize('range-picker.nzDisabled.description', 'determine whether the nz-date-picker is disabled'),
'range-picker.nzDisabledDate.description': localize('range-picker.nzDisabledDate.description', 'specify the date that cannot be selected (Not support by year-picker)'),
'range-picker.nzLocale.description': localize('range-picker.nzLocale.description', 'localization configuration'),
'range-picker.nzOpen.description': localize('range-picker.nzOpen.description', 'open state of picker'),
'range-picker.nzPopupStyle.description': localize('range-picker.nzPopupStyle.description', 'to customize the style of the popup calendar'),
'range-picker.nzDropdownClassName.description': localize('range-picker.nzDropdownClassName.description', 'to customize the className of the popup calendar'),
'range-picker.nzSize.description': localize('range-picker.nzSize.description', 'determine the size of the input box, the height of `large` and `small`, are 40px and 24px respectively, while default size is 32px'),
'range-picker.nzStyle.description': localize('range-picker.nzStyle.description', 'to customize the style of the input box'),
'range-picker.nzDisabledTime.description': localize('range-picker.nzDisabledTime.description', 'to specify the time that cannot be selected'),
'range-picker.nzFormat.description': localize('range-picker.nzFormat.description', 'to set the date format'),
'range-picker.nzRanges.description': localize('range-picker.nzRanges.description', 'preseted ranges for quick selection'),
'range-picker.nzRenderExtraFooter.description': localize('range-picker.nzRenderExtraFooter.description', 'render extra footer in panel'),
'range-picker.nzShowTime.description': localize('range-picker.nzShowTime.description', 'to provide an additional time selection'),
'range-picker.nzPlaceHolder.description': localize('range-picker.nzPlaceHolder.description', 'placeholder of date input'),
'range-picker.nzOnOk.description': localize('range-picker.nzOnOk.description', 'click ok callback'),
'range-picker.ngModelChange.description': localize('range-picker.ngModelChange.description', 'Date change callback'),
'range-picker.nzOnOpenChange.description': localize('range-picker.nzOnOpenChange.description', 'a callback emitter, can be executed whether the popup calendar is popped up or closed'),
'range-picker.enabled.description': localize('range-picker.enabled.description', 'Shortcut list'),
'range-picker.closed.description': localize('range-picker.closed.description', 'Whether to close the panel after clicking'),
...
'full-content.description': localize('full-content.description', 'Often used for tables with scroll bars, a simple [demo](https://ng-alain.surge.sh/#/delon/simple-table)。'),
...
'qr.description': localize('qr.description', 'Generate a QR code based on [qrious](https://neocotic.com/qrious).'),
'qr.src.description': localize('qr.src.description', 'Specify path of the pdf'),
'qr.pi.description': localize('qr.pi.description', 'Current page'),
'qr.showAll.description': localize('qr.showAll.description', 'Whether to show all pages'),
'qr.renderText.description': localize('qr.renderText.description', 'Enable text rendering, allows to select text'),
'qr.textLayerMode.description': localize('qr.textLayerMode.description', 'Text rendering mode'),
'qr.showBorders.description': localize('qr.showBorders.description', 'Show page borders'),
'qr.stickToPage.description': localize('qr.stickToPage.description', 'Sticks view to the page'),
'qr.originalSize.description': localize('qr.originalSize.description', 'Control document display size, `true` size will be as same as original document, `false` size will be as same as container block'),
'qr.fitToPage.description': localize('qr.fitToPage.description', 'Works in combination with `originalSize`. You can show your document in original size, and make sure that it\'s not bigger then container block.'),
'qr.zoom.description': localize('qr.zoom.description', 'Zoom pdf'),
'qr.zoomScale.description': localize('qr.zoomScale.description', 'Defines how the Zoom scale is computed'),
'qr.rotation.description': localize('qr.rotation.description', 'Rotate PDF, Allowed step is 90 degree, ex. 0, 90, 180'),
'qr.autoReSize.description': localize('qr.autoReSize.description', 'Turn on or off auto resize'),
'qr.externalLinkTarget.description': localize('qr.externalLinkTarget.description', 'Link target of the external'),
...
'st.lazyLoad.description': localize('st.lazyLoad.description', 'Whether to dealy loading data in first render `st` component'),
...
'g2-mini-area.xAxis.description': localize('g2-mini-area.xAxis.description', '[x 轴配置](https://www.yuque.com/antv/g2-docs/api-chart#frgaiw)'),
'g2-mini-area.yAxis.description': localize('g2-mini-area.yAxis.description', '[y 轴配置](https://www.yuque.com/antv/g2-docs/api-chart#frgaiw)'),
...
'g2-timeline.mask.description': localize('g2-timeline.mask.description', '日期格式，使用 [G2 Mask日期格式](https://g2.antv.vision/zh/docs/manual/concepts/data-and-scales#time)'),
...
export const DATA = [
  {
    ...
    "properties": [
      ...
      },
      {
        ...
        "type": "Enum",
        "typeRaw": "`number|object|[number, number]|[object, object]`",
        "default": "`0`",
        "pureDefault": "0",
        "typeDefinition": [
          "0",
  ...
  },
  {
    ...
    "properties": [
      ...
      },
      {
        "name": "nzAutoFit",
        "inputType": 0,
        "description": "nz-graph.nzAutoFit.description",
        "type": "boolean",
        "typeRaw": "`boolean`",
        "default": "`false`",
        "pureDefault": "false"
  ...
  },
  {
    ...
    "properties": [
      ...
      },
      {
        "name": "nzGetContainer",
        "inputType": 0,
        "description": "nz-modal.nzGetContainer.description",
        "type": "object",
        "typeRaw": "HTMLElement / () => HTMLElement",
        "default": "A default container",
        "pureDefault": "A default container"
      },
      {
        "name": "nzKeyboard",
        "inputType": 0,
  ...
  },
  {
    ...
    "properties": [
      ...
      },
      {
        "name": "nzNodeWidth",
        "inputType": 0,
        "description": "nz-tree-virtual-scroll-view.nzNodeWidth.description",
        "type": "number",
        "typeRaw": "`number`",
        "default": "`28`",
        "pureDefault": "28"
      ...
      "DateRangePickerShortcut": [
        {
          "name": "enabled",
          "inputType": 0,
          "description": "range-picker.enabled.description",
          "type": "boolean",
          "typeRaw": "`boolean`",
          "default": "`false`",
          "pureDefault": "false"
        },
        {
          "name": "closed",
          "inputType": 0,
          "description": "range-picker.closed.description",
          "type": "boolean",
          "typeRaw": "`boolean`",
          "default": "`true`",
          "pureDefault": "true"
    ...
    "properties": [
      {
        "name": "ngModel",
        "inputType": 2,
        "description": "range-picker.ngModel.description",
        "type": "object",
        "typeRaw": "`Date`",
        "default": ""
      },
      {
        "name": "ngModelEnd",
        "inputType": 2,
        "description": "range-picker.ngModelEnd.description",
        "type": "object",
        "typeRaw": "`Date`",
        "default": ""
      },
      {
        "name": "shortcut",
        "inputType": 0,
        "description": "range-picker.shortcut.description",
        "type": "boolean",
      ...
      },
      {
        "name": "nzAllowClear",
        "inputType": 0,
        "description": "range-picker.nzAllowClear.description",
        "type": "boolean",
        "typeRaw": "`boolean`",
        "default": "`true`",
        "pureDefault": "true"
      },
      {
        "name": "nzAutoFocus",
        "inputType": 0,
        "description": "range-picker.nzAutoFocus.description",
        "type": "boolean",
        "typeRaw": "`boolean`",
        "default": "`false`",
        "pureDefault": "false"
      },
      {
        "name": "nzClassName",
        "inputType": 0,
        "description": "range-picker.nzClassName.description",
        "type": "string",
        "typeRaw": "`string`",
        "default": "`''`",
        "pureDefault": ""
      },
      {
        "name": "nzDateRender",
        "inputType": 0,
        "description": "range-picker.nzDateRender.description",
        "type": "TemplateRef",
      ...
      },
      {
        "name": "nzDisabled",
        "inputType": 0,
        "description": "range-picker.nzDisabled.description",
        "type": "boolean",
        "typeRaw": "`boolean`",
        "default": "`false`",
        "pureDefault": "false",
      ...
      },
      {
        "name": "nzDisabledDate",
        "inputType": 0,
        "description": "range-picker.nzDisabledDate.description",
        "type": "function",
        "typeRaw": "`(current: Date) => boolean`",
        "default": ""
      },
      {
        "name": "nzLocale",
        "inputType": 0,
        "description": "range-picker.nzLocale.description",
        "type": "object",
        "typeRaw": "`object`",
        "default": "[default](https://github.com/ant-design/ant-design/blob/master/components/date-picker/locale/example.json)",
        "pureDefault": "[default](https://github.com/ant-design/ant-design/blob/master/components/date-picker/locale/example.json)"
      },
      {
        "name": "nzOpen",
        "inputType": 0,
        "description": "range-picker.nzOpen.description",
        "type": "boolean",
        "typeRaw": "`boolean`",
        "default": ""
      },
      {
        "name": "nzPopupStyle",
        "inputType": 0,
        "description": "range-picker.nzPopupStyle.description",
        "type": "object",
        "typeRaw": "`object`",
        "default": "`{}`",
        "pureDefault": "{}"
      },
      {
        "name": "nzDropdownClassName",
        "inputType": 0,
        "description": "range-picker.nzDropdownClassName.description",
        "type": "string",
        "typeRaw": "`string`",
        "default": ""
      },
      {
        "name": "nzSize",
        "inputType": 0,
        "description": "range-picker.nzSize.description",
        "type": "Enum",
        "typeRaw": "`'large'｜'small'`",
        "default": "",
        "typeDefinition": [
      ...
      },
      {
        "name": "nzStyle",
        "inputType": 0,
        "description": "range-picker.nzStyle.description",
        "type": "object",
        "typeRaw": "`object`",
        "default": "`{}`",
        "pureDefault": "{}"
      },
      {
        "name": "nzDisabledTime",
        "inputType": 0,
        "description": "range-picker.nzDisabledTime.description",
        "type": "function",
      ...
      },
      {
        "name": "nzFormat",
        "inputType": 0,
        "description": "range-picker.nzFormat.description",
        "type": "string",
        "typeRaw": "`string`",
        "default": "`\"yyyy-MM-dd\"`",
      ...
      },
      {
        "name": "nzRanges",
        "inputType": 0,
        "description": "range-picker.nzRanges.description",
        "type": "object",
      ...
      },
      {
        "name": "nzRenderExtraFooter",
        "inputType": 0,
        "description": "range-picker.nzRenderExtraFooter.description",
        "type": "TemplateRef",
        "typeRaw": "`TemplateRef｜string｜(() => TemplateRef｜string)`",
        "default": ""
      },
      {
        "name": "nzShowTime",
        "inputType": 0,
        "description": "range-picker.nzShowTime.description",
        "type": "object",
      ...
      },
      {
        "name": "nzPlaceHolder",
        "inputType": 0,
        "description": "range-picker.nzPlaceHolder.description",
        "type": "Array",
        "typeRaw": "`string[]`",
        "default": ""
      },
      {
        "name": "nzOnOk",
        "inputType": 1,
        "description": "range-picker.nzOnOk.description",
        "type": "EventEmitter",
        "typeRaw": "`EventEmitter<Date[]>`",
        "default": ""
      },
      {
        "name": "ngModelChange",
        "inputType": 1,
        "description": "range-picker.ngModelChange.description",
        "type": "EventEmitter",
        "typeRaw": "`EventEmitter<Date[]>`",
        "default": ""
      },
      {
        "name": "nzOnOpenChange",
        "inputType": 1,
        "description": "range-picker.nzOnOpenChange.description",
        "type": "EventEmitter",
        "typeRaw": "`EventEmitter<boolean>`",
        "default": ""
      }
    ...
    "properties": [
      {
        "name": "src",
        "inputType": 0,
        "description": "qr.src.description",
        "type": "string",
      ...
      },
      {
        "name": "showAll",
        "inputType": 0,
        "description": "qr.showAll.description",
        "type": "boolean",
        "typeRaw": "`boolean`",
        "default": "`true`",
        "pureDefault": "true"
      },
      {
        "name": "renderText",
        "inputType": 0,
        "description": "qr.renderText.description",
        "type": "boolean",
        "typeRaw": "`boolean`",
        "default": "`true`",
        "pureDefault": "true"
      },
      {
        "name": "textLayerMode",
        "inputType": 0,
        "description": "qr.textLayerMode.description",
        "type": "object",
      ...
      },
      {
        "name": "showBorders",
        "inputType": 0,
        "description": "qr.showBorders.description",
        "type": "boolean",
        "typeRaw": "`boolean`",
        "default": "`false`",
        "pureDefault": "false"
      },
      {
        "name": "stickToPage",
        "inputType": 0,
        "description": "qr.stickToPage.description",
        "type": "boolean",
        "typeRaw": "`boolean`",
        "default": "`false`",
        "pureDefault": "false"
      },
      {
        "name": "originalSize",
        "inputType": 0,
        "description": "qr.originalSize.description",
        "type": "boolean",
        "typeRaw": "`boolean`",
        "default": "`true`",
        "pureDefault": "true"
      },
      {
        "name": "fitToPage",
        "inputType": 0,
        "description": "qr.fitToPage.description",
        "type": "boolean",
        "typeRaw": "`boolean`",
        "default": "`false`",
        "pureDefault": "false"
      },
      {
        "name": "zoom",
        "inputType": 0,
        "description": "qr.zoom.description",
        "type": "number",
        "typeRaw": "`number`",
        "default": "`1`",
        "pureDefault": "1"
      },
      {
        "name": "zoomScale",
        "inputType": 0,
        "description": "qr.zoomScale.description",
        "type": "object",
      ...
      },
      {
        "name": "rotation",
        "inputType": 0,
        "description": "qr.rotation.description",
        "type": "number",
        "typeRaw": "`number`",
        "default": "`0`",
        "pureDefault": "0"
      },
      {
        "name": "autoReSize",
        "inputType": 0,
        "description": "qr.autoReSize.description",
        "type": "boolean",
        "typeRaw": "`boolean`",
        "default": "`true`",
        "pureDefault": "true"
      },
      {
        ...
        "inputType": 0,
        "description": "qr.externalLinkTarget.description",
        "type": "object",
