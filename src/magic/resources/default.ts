...
'nz-anchor.nzDirection.description': localize('nz-anchor.nzDirection.description', "Set Anchor direction"),
...
'nz-autocomplete.compareWith.description': localize('nz-autocomplete.compareWith.description', "Same as [SelectControlValueAccessor](https://angular.dev/api/forms/SelectControlValueAccessor)"),
...
'nz-breadcrumb.nzRouteFn.description': localize('nz-breadcrumb.nzRouteFn.description', "Format breadcrumb item route, normally used in international app to bind current params or query strings to avoid losing them while navigate using breadcrumb. It should be used when `nzAutoGenerate` is `true`"),
...
'nz-calendar.nzCustomHeader.description': localize('nz-calendar.nzCustomHeader.description', "Render custom header in panel"),
...
'nz-card.nzBordered.description': localize('nz-card.nzBordered.description', "Toggles rendering of the border around the card"),
...
'nz-cascader.whenToUse': localize('nz-cascader.whenToUse', "- When you need to select from a set of a hierarchical structure. Such as province/city/district, company level, and classification.\n- When selecting from a large data set, with multi-stage classification separated for easy selection.\n- Chooses cascade items in one float layer for a better user experience."),
...
'nz-cascader.nzChangeOn.description': localize('nz-cascader.nzChangeOn.description', "change value on each selection if this function returns `true`"),
...
'nz-cascader.nzDisabled.description': localize('nz-cascader.nzDisabled.description', "whether select should be disabled"),
...
'nz-cascader.nzExpandTrigger.description': localize('nz-cascader.nzExpandTrigger.description', "expand current item when clicked or hovered, one of 'click' 'hover'"),
...
'nz-cascader.nzLoadData.description': localize('nz-cascader.nzLoadData.description', "to load option lazily. Lazy load will be called immediately if the setting is `ngModel` with an array value and `nzOptions` is not set"),
...
'nz-cascader.nzMouseEnterDelay.description': localize('nz-cascader.nzMouseEnterDelay.description', "duration in milliseconds before opening the popup overlay when the mouse enters the trigger"),
'nz-cascader.nzMouseLeaveDelay.description': localize('nz-cascader.nzMouseLeaveDelay.description', "duration in milliseconds before closing the popup overlay when the mouse leaves the trigger"),
'nz-cascader.nzMenuStyle.description': localize('nz-cascader.nzMenuStyle.description', "additional css style of popup overlay"),
'nz-cascader.nzMultiple.description': localize('nz-cascader.nzMultiple.description', "support multiple or not"),
...
'nz-cascader.nzPlacement.description': localize('nz-cascader.nzPlacement.description', "popup placement"),
...
'nz-cascader.nzSuffixIcon.description': localize('nz-cascader.nzSuffixIcon.description', "custom suffix icon"),
'nz-cascader.nzValueProperty.description': localize('nz-cascader.nzValueProperty.description', "value property name of options"),
...
'nz-cascader.nzRemoved.description': localize('nz-cascader.nzRemoved.description', "emit on selected item removed when `nzMultiple` is `true`"),
...
'nz-checkbox.nzName.description': localize('nz-checkbox.nzName.description', "input name attribute inside the component"),
...
'nz-checkbox-group.nzName.description': localize('nz-checkbox-group.nzName.description', "The `name` property of all input children"),
'nz-checkbox-group.nzOptions.description': localize('nz-checkbox-group.nzOptions.description', "Specifies options"),
...
'nz-date-picker.nzOnPanelChange.description': localize('nz-date-picker.nzOnPanelChange.description', "a callback emitter, can be executed when the panel changes"),
...
'nz-range-picker.nzOnPanelChange.description': localize('nz-range-picker.nzOnPanelChange.description', "a callback emitter, can be executed when the panel changes"),
...
'nz-divider.nzVariant.description': localize('nz-divider.nzVariant.description', "Whether line is dashed, dotted or solid"),
...
'nz-drawer.nzOffsetX.description': localize('nz-drawer.nzOffsetX.description', "The X coordinate offset(px), only when placement is `'right'` or `'left'`."),
'nz-drawer.nzOffsetY.description': localize('nz-drawer.nzOffsetY.description', "The Y coordinate offset(px), only when placement is `'top'` or `'bottom'`."),
...
'nz-float-button-group.title': localize('nz-float-button-group.title', "FloatButton"),
'nz-float-button-group.whenToUse': localize('nz-float-button-group.whenToUse', "- For global functionality on the site.\n- Buttons that can be seen wherever you browse."),
'nz-float-button-group.description': localize('nz-float-button-group.description', "When To Use"),
'nz-float-button-group.nzShape.description': localize('nz-float-button-group.nzShape.description', "Set button group shape"),
'nz-float-button-group.nzTrigger.description': localize('nz-float-button-group.nzTrigger.description', "Which action can trigger menu open/close"),
'nz-float-button-group.nzOpen.description': localize('nz-float-button-group.nzOpen.description', "Whether the menu is visible or not"),
'nz-float-button-group.nzOnOpenChange.description': localize('nz-float-button-group.nzOnOpenChange.description', "Callback executed when active menu is changed"),
'nz-float-button-top.title': localize('nz-float-button-top.title', "FloatButton"),
'nz-float-button-top.whenToUse': localize('nz-float-button-top.whenToUse', "- For global functionality on the site.\n- Buttons that can be seen wherever you browse."),
'nz-float-button-top.description': localize('nz-float-button-top.description', "When To Use"),
'nz-float-button-top.nzVisibilityHeight.description': localize('nz-float-button-top.nzVisibilityHeight.description', "the `nz-float-button-top` button will not show until the scroll height reaches this value"),
'nz-float-button-top.nzTarget.description': localize('nz-float-button-top.nzTarget.description', "specifies the scrollable area dom node"),
'nz-float-button-top.nzDuration.description': localize('nz-float-button-top.nzDuration.description', "Time to return to top (ms)"),
'nz-float-button-top.nzOnClick.description': localize('nz-float-button-top.nzOnClick.description', "a callback function, which can be executed when you click the button"),
...
'nz-input-otp.title': localize('nz-input-otp.title', "Input"),
'nz-input-otp.whenToUse': localize('nz-input-otp.whenToUse', "- A user input in a form field is needed.\n- A search input is required."),
'nz-input-otp.description': localize('nz-input-otp.description', "A basic widget for getting the user input is a text field.\nKeyboard and mouse can be used for providing or changing data."),
'nz-input-otp.disabled.description': localize('nz-input-otp.disabled.description', "Whether the input is disabled"),
'nz-input-otp.nzFormatter.description': localize('nz-input-otp.nzFormatter.description', "Format display, blank fields will be filled with ` `"),
'nz-input-otp.nzMask.description': localize('nz-input-otp.nzMask.description', "Custom display, the original value will not be modified"),
'nz-input-otp.nzLength.description': localize('nz-input-otp.nzLength.description', "The number of input elements"),
'nz-input-otp.nzStatus.description': localize('nz-input-otp.nzStatus.description', "Set validation status"),
'nz-input-otp.nzSize.description': localize('nz-input-otp.nzSize.description', "The size of the input box"),
'nz-input-number.title': localize('nz-input-number.title', "InputNumberLegacy"),
...
'nz-input-number.nzBordered.description': localize('nz-input-number.nzBordered.description', "whether to have border"),
'nz-input-number.nzControls.description': localize('nz-input-number.nzControls.description', "whether to show up and down buttons"),
...
'nz-input-number.nzOnStep.description': localize('nz-input-number.nzOnStep.description', "callback when clicking the up and down arrows"),
...
'nz-input-number-group.title': localize('nz-input-number-group.title', "InputNumberLegacy"),
...
'nz-menu-item.nzMatchRouterExact.description': localize('nz-menu-item.nzMatchRouterExact.description', "only match when the url matches the link exactly, same as [routerLinkActiveOptions](https://angular.dev/api/router/RouterLinkActive#routerLinkActiveOptions)"),
...
'nz-submenu.nzTriggerSubMenuAction.description': localize('nz-submenu.nzTriggerSubMenuAction.description', "Which action can trigger submenu open/close"),
...
'nz-modal.nzDraggable.description': localize('nz-modal.nzDraggable.description', "Whether modal is draggable or not"),
...
'nz-modal.nzData.description': localize('nz-modal.nzData.description', "Will be a template variable when `nzContent` is `TemplateRef`"),
...
'nzModalTitle.whenToUse': localize('nzModalTitle.whenToUse', "When requiring users to interact with the application without jumping to a new page to interrupt the user's workflow,\nyou can use `Modal` to create a new floating layer over the current page for user-getting feedback or information\npurposes. Additionally, if you need to show a simple confirmation dialog, you can use `NzModalService.confirm()` and so\non."),
...
'nzModalContent.whenToUse': localize('nzModalContent.whenToUse', "When requiring users to interact with the application without jumping to a new page to interrupt the user's workflow,\nyou can use `Modal` to create a new floating layer over the current page for user-getting feedback or information\npurposes. Additionally, if you need to show a simple confirmation dialog, you can use `NzModalService.confirm()` and so\non."),
...
'nzModalFooter.whenToUse': localize('nzModalFooter.whenToUse', "When requiring users to interact with the application without jumping to a new page to interrupt the user's workflow,\nyou can use `Modal` to create a new floating layer over the current page for user-getting feedback or information\npurposes. Additionally, if you need to show a simple confirmation dialog, you can use `NzModalService.confirm()` and so\non."),
...
'nz-popconfirm.nzPopconfirmTitleContext.description': localize('nz-popconfirm.nzPopconfirmTitleContext.description', "The context of confirmation box title"),
...
'nz-popconfirm.nzOkDisabled.description': localize('nz-popconfirm.nzOkDisabled.description', "prevents a user from interacting with the OK button. <i>Consistent with the `disabled` of the `nz-button`.</i>"),
...
'nz-qrcode.nzStatus.description': localize('nz-qrcode.nzStatus.description', "QR code status"),
'nz-qrcode.nzStatusRender.description': localize('nz-qrcode.nzStatusRender.description', "custom status"),
'nz-qrcode.nzLevel.description': localize('nz-qrcode.nzLevel.description', "Error Code Level"),
'nz-qrcode.nzRefresh.description': localize('nz-qrcode.nzRefresh.description', "callback"),
...
'nz-rate.nzOnHoverChange.description': localize('nz-rate.nzOnHoverChange.description', "callback when hover / leave item"),
...
'nz-segmented.title': localize('nz-segmented.title', "Segmented"),
'nz-segmented.whenToUse': localize('nz-segmented.whenToUse', "- When displaying multiple options and user can select a single option;\n- When switching the selected option, the content of the associated area changes."),
'nz-segmented.description': localize('nz-segmented.description', "When To Use"),
'nz-segmented.nzBlock.description': localize('nz-segmented.nzBlock.description', "Option to fit width to its parent\'s width"),
'nz-segmented.nzDisabled.description': localize('nz-segmented.nzDisabled.description', "Disable all segments"),
'nz-segmented.nzOptions.description': localize('nz-segmented.nzOptions.description', "Set children optional"),
'nz-segmented.nzSize.description': localize('nz-segmented.nzSize.description', "The size of the Segmented"),
'nz-segmented.ngModel.description': localize('nz-segmented.ngModel.description', "Value of the currently selected option"),
'nz-segmented.nzValueChange.description': localize('nz-segmented.nzValueChange.description', "Emits when value of the currently selected option changes"),
'nz-segmented.ngModelChange.description': localize('nz-segmented.ngModelChange.description', "Emits when value of the currently selected option changes"),
...
'nz-select.compareWith.description': localize('nz-select.compareWith.description', "Same as [SelectControlValueAccessor](https://angular.dev/api/forms/SelectControlValueAccessor)"),
...
'nz-space-compact.title': localize('nz-space-compact.title', "Space"),
'nz-space-compact.whenToUse': localize('nz-space-compact.whenToUse', "Avoid components clinging together and set a unified space."),
'nz-space-compact.description': localize('nz-space-compact.description', "Use `<nz-space-compact>` when child form components are compactly connected and the border is collapsed. The supported components are："),
'nz-space-compact.nzBlock.description': localize('nz-space-compact.nzBlock.description', "Option to fit width to its parent\'s width"),
'nz-space-compact.nzDirection.description': localize('nz-space-compact.nzDirection.description', "Set direction of layout"),
'nz-space-compact.nzSize.description': localize('nz-space-compact.nzSize.description', "Set child component size"),
...
'nz-statistic.nzLoading.description': localize('nz-statistic.nzLoading.description', "Loading status of Statistic"),
...
'nz-table.noDataVirtualHeight.description': localize('nz-table.noDataVirtualHeight.description', "Height of inner scroll when having no data, if nothing is passed the default value is used."),
...
'thead.title': localize('thead.title', "Table"),
'thead.whenToUse': localize('thead.whenToUse', "- To display a collection of structured data.\n- To sort, search, paginate and filter data."),
'thead.description': localize('thead.description', "A table displays rows of data."),
'thead.nzSortOrderChange.description': localize('thead.nzSortOrderChange.description', "sort change callback，should used with `nzColumnKey` of `th`"),
...
'tfoot.title': localize('tfoot.title', "Table"),
'tfoot.whenToUse': localize('tfoot.whenToUse', "- To display a collection of structured data.\n- To sort, search, paginate and filter data."),
'tfoot.description': localize('tfoot.description', "A table displays rows of data."),
'tfoot.nzSummary.description': localize('tfoot.nzSummary.description', "Summary content"),
'tfoot.nzFixed.description': localize('tfoot.nzFixed.description', "Fixed summary, used with `nzScroll`"),
...
'nz-tabset.nzDestroyInactiveTabPane.description': localize('nz-tabset.nzDestroyInactiveTabPane.description', "Whether destroy inactive TabPane when change tab"),
...
'nz-transfer.nzShowSelectAll.description': localize('nz-transfer.nzShowSelectAll.description', "Whether to display the select all box"),
...
'nz-transfer.nzOneWay.description': localize('nz-transfer.nzOneWay.description', "Display as single direction style"),
...
'nz-tree.nzCheckable.description': localize('nz-tree.nzCheckable.description', "Add a checkbox before the treeNodes"),
...
'nzTreeNodeToggleRotateIcon.title': localize('nzTreeNodeToggleRotateIcon.title', "Tree View"),
'nzTreeNodeToggleRotateIcon.whenToUse': localize('nzTreeNodeToggleRotateIcon.whenToUse', "More basic Tree component, allowing each of its parts to be defined in the template, and state to be managed manually.\nWith better performance and customizability."),
'nzTreeNodeToggleRotateIcon.description': localize('nzTreeNodeToggleRotateIcon.description', "Define an icon in the toggle, which it will automatically rotate depending on the collapse/expand state."),
'nzTreeNodeToggleRotateIcon.nzSelected.description': localize('nzTreeNodeToggleRotateIcon.nzSelected.description', "Whether the option is selected"),
'nzTreeNodeToggleRotateIcon.nzDisabled.description': localize('nzTreeNodeToggleRotateIcon.nzDisabled.description', "Whether the option is disabled"),
'nzTreeNodeToggleRotateIcon.nzClick.description': localize('nzTreeNodeToggleRotateIcon.nzClick.description', "Event on click"),
'nzTreeNodeToggleActiveIcon.title': localize('nzTreeNodeToggleActiveIcon.title', "Tree View"),
'nzTreeNodeToggleActiveIcon.whenToUse': localize('nzTreeNodeToggleActiveIcon.whenToUse', "More basic Tree component, allowing each of its parts to be defined in the template, and state to be managed manually.\nWith better performance and customizability."),
'nzTreeNodeToggleActiveIcon.description': localize('nzTreeNodeToggleActiveIcon.description', "Define an icon in the toggle for an active style, which it can be used for the loading state."),
'nzTreeNodeToggleActiveIcon.nzSelected.description': localize('nzTreeNodeToggleActiveIcon.nzSelected.description', "Whether the option is selected"),
'nzTreeNodeToggleActiveIcon.nzDisabled.description': localize('nzTreeNodeToggleActiveIcon.nzDisabled.description', "Whether the option is disabled"),
'nzTreeNodeToggleActiveIcon.nzClick.description': localize('nzTreeNodeToggleActiveIcon.nzClick.description', "Event on click"),
...
'nz-water-mark.title': localize('nz-water-mark.title', "WaterMark"),
'nz-water-mark.whenToUse': localize('nz-water-mark.whenToUse', "- Use when the page needs to be watermarked to identify the copyright.\n- Suitable for preventing information theft."),
'nz-water-mark.description': localize('nz-water-mark.description', "Add specific text or patterns to the page."),
'nz-water-mark.nzContent.description': localize('nz-water-mark.nzContent.description', "Watermark text content"),
'nz-water-mark.nzWidth.description': localize('nz-water-mark.nzWidth.description', "The width of the watermark, the default value of `nzContent` is its own width"),
'nz-water-mark.nzHeight.description': localize('nz-water-mark.nzHeight.description', "The height of the watermark, the default value of `nzContent` is its own height"),
'nz-water-mark.nzRotate.description': localize('nz-water-mark.nzRotate.description', "When the watermark is drawn, the rotation Angle, unit `°`"),
'nz-water-mark.nzZIndex.description': localize('nz-water-mark.nzZIndex.description', "The z-index of the appended watermark element"),
'nz-water-mark.nzImage.description': localize('nz-water-mark.nzImage.description', "Image source, it is recommended to export 2x or 3x image, high priority (support base64 format)"),
'nz-water-mark.nzFont.description': localize('nz-water-mark.nzFont.description', "Text style"),
'nz-water-mark.nzGap.description': localize('nz-water-mark.nzGap.description', "The spacing between watermarks"),
'nz-water-mark.nzOffset.description': localize('nz-water-mark.nzOffset.description', "The offset of the watermark from the upper left corner of the container. The default is `nzGap/2`"),
'nz-water-mark.color.description': localize('nz-water-mark.color.description', "font color"),
'nz-water-mark.fontSize.description': localize('nz-water-mark.fontSize.description', "font size"),
'nz-water-mark.fontWeight.description': localize('nz-water-mark.fontWeight.description', "font weight"),
'nz-water-mark.fontFamily.description': localize('nz-water-mark.fontFamily.description', "font family"),
'nz-water-mark.fontStyle.description': localize('nz-water-mark.fontStyle.description', "font style"),
...
'result.description': localize('result.description', "Will be removed in v20, Please use `nz-result` instead."),
...
'st.expandIcon.description': localize('st.expandIcon.description', "Custom expand icon"),
