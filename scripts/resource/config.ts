export const COG = {
  ...
  COMMON_PROPERTIES: {
    ...
    "nz-date-picker": [
      ...
      {
        zh: `nz-date-picker[nzMode="date"]`,
        en: `nz-date-picker[nzMode="date"]`,
      },
    ],
    "nz-range-picker": [
      { zh: "共同的 API", en: "Common API" },
      {
        zh: `nz-range-picker[nzMode="date"]`,
        en: `nz-range-picker[nzMode="date"]`,
      },
    ],
  },
  /** 强制合并属性至组件内 */
